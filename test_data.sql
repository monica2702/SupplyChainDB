...
INSERT INTO EMPLOYEE 
    (EMP_ID, EMP_NAME, EMP_DOB, EMP_STREET, EMP_CITY, EMP_STATE, EMP_ZIP, EMP_HIREDATE) 
    VALUES 
    (EMP_ID_SEQ.NEXTVAL, 'KATHY BLEAK','27-FEB-1992','801 E WAYNE AVENUE','WOOSTER','OHIO','44691','30-APR-2018');
...
INSERT INTO PURCHASE_ORDER
    ...
    VALUES
    (PO_NO_SEQ.NEXTVAL, 4005, '06-MAR-2014', 3000);
...
INSERT INTO PURCHASE_ORDER
    (PO_NO, PART_APPR_ID, PO_DATE, ITEM_QTY)
    VALUES
    (PO_NO_SEQ.NEXTVAL, 4008, '18-FEB-2012', 1090);
    
INSERT INTO PURCHASE_ORDER
    (PO_NO, PART_APPR_ID, PO_DATE, ITEM_QTY)
    VALUES
    (PO_NO_SEQ.NEXTVAL, 4001, '27-FEB-2019', 325);
