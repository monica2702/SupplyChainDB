...
INSERT INTO EMPLOYEE 
    (EMP_ID, EMP_NAME, EMP_DOB, EMP_STREET, EMP_CITY, EMP_STATE, EMP_ZIP, EMP_HIREDATE) 
    VALUES 
    (EMP_ID_SEQ.NEXTVAL, 'PATRICK HANSEN','25-SEP-1985','485 PEASANT STREET','COLORADO SPRINGS','SPRINGS','80772','05-AUG-2010');
...
INSERT INTO PROGRAMS
    ...
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'CATERPILLAR', '03-JAN-2014', '02-JAN-2019', 1650, 1800, 'DELAYED', '10001');
...
INSERT INTO PROGRAMS
    (PROG_ID, PROG_NAME, PROG_START, PROG_END, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY, PROG_STATUS, CUST_ID) 
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'HORIZON', '11-APR-2016', '10-APR-2021', 375, 500, 'OPEN', '10002');
...
INSERT INTO OUTGOING_INVOICE
    ...
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '21-AUG-2017', 1400, 'NUMBER', 0.67, 'PER-PIECE', 60001); 
    
INSERT INTO OUTGOING_INVOICE
    (OUT_INV_NO, OUT_INV_DATE, QUANTITY, QTY_UNIT, COST_PER_UNIT, COST_UNIT, PROG_PART_ID)
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '03-SEP-2018', 850, 'NUMBER', 0.67, 'PER-PIECE', 60001); 
...
INSERT INTO OUTGOING_INVOICE
    (OUT_INV_NO, OUT_INV_DATE, QUANTITY, QTY_UNIT, COST_PER_UNIT, COST_UNIT, PROG_PART_ID)
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '31-JAN-2017', 1950, 'NUMBER', 1.05, 'PER-PIECE', 60003);

INSERT INTO OUTGOING_INVOICE
    (OUT_INV_NO, OUT_INV_DATE, QUANTITY, QTY_UNIT, COST_PER_UNIT, COST_UNIT, PROG_PART_ID)
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '15-MAY-2019', 1000, 'NUMBER', 1.32, 'PER-PIECE', 60002);

INSERT INTO OUTGOING_INVOICE
    (OUT_INV_NO, OUT_INV_DATE, QUANTITY, QTY_UNIT, COST_PER_UNIT, COST_UNIT, PROG_PART_ID)
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '07-OCT-2018', 12000, 'NUMBER', 0.47, 'PER-PIECE', 60006);
    
INSERT INTO OUTGOING_INVOICE
    (OUT_INV_NO, OUT_INV_DATE, QUANTITY, QTY_UNIT, COST_PER_UNIT, COST_UNIT, PROG_PART_ID)
    VALUES
    (OUT_INV_NO_SEQ.NEXTVAL, '30-NOV-2015', 1350, 'NUMBER', 1.30, 'PER-PIECE', 60007);
...
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50000, 303, 'APPROVED', '13-JAN-2019', 123460, 1.6, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50001, 305, 'APPROVED', '20-JUL-2015', 123459, 0.43, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50002, 302, 'APPROVED', '24-AUG-2013', 123458, 2.16, NULL, NULL);
    
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50004, 302, 'PENDING', NULL, 123460, NULL, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'APPROVED', '11-SEP-2015', 123457, 1.22, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'DENIED', '09-NOV-2013', 123457, 1.10, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50005, 304, 'PENDING', NULL, 123457, NULL, NULL, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 306, 'APPROVED', '22-JAN-2012', 123458, 0.96, NULL, NULL); 

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 307, 'PENDING', NULL, 123458, NULL, NULL, NULL);  
...
INSERT INTO PURCHASE_ORDER
    ...
    VALUES
    (PO_NO_SEQ.NEXTVAL, 4006, '06-MAR-2014', 3000);
...
INSERT INTO PURCHASE_ORDER
    (PO_NO, PART_APPR_ID, PO_DATE, ITEM_QTY)
    VALUES
    (PO_NO_SEQ.NEXTVAL, 4005, '17-JAN-2017', 1350);
