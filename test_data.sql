...
INSERT INTO PROGRAMS
    ...
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'CATERPILLAR', '03-JAN-2014', '02-JAN-2019', 'DELAYED', '10001');
    
INSERT INTO PROGRAMS
    (PROG_ID, PROG_NAME, PROG_START, PROG_END, PROG_STATUS, CUST_ID) 
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'STARDUST', '01-JUL-2017', '30-JUN-2022', 'OPEN', '10001');
 
INSERT INTO PROGRAMS
    (PROG_ID, PROG_NAME, PROG_START, PROG_END, PROG_STATUS, CUST_ID) 
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'SIGNPLUS', '27-FEB-2012', '26-FEB-2017', 'CLOSED', '10003');
    
INSERT INTO PROGRAMS
    (PROG_ID, PROG_NAME, PROG_START, PROG_END, PROG_STATUS, CUST_ID) 
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'P1ORANGE', '11-MAR-2011', '10-MAR-2016', 'CLOSED', '10004');
    
INSERT INTO PROGRAMS
    (PROG_ID, PROG_NAME, PROG_START, PROG_END, PROG_STATUS, CUST_ID) 
    VALUES 
    (PROG_ID_SEQ.NEXTVAL, 'HORIZON', '11-APR-2016', '10-APR-2021', 'OPEN', '10002');
...
INSERT INTO APPROVAL_DETAILS
    ...
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50000, 303, 'APPROVED', '13-JAN-2019', 123460, 1.6);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50001, 305, 'APPROVED', '20-JUL-2015', 123459, 0.43);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50002, 302, 'APPROVED', '24-AUG-2013', 123458, 2.16);
    
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50004, 302, 'PENDING', NULL, 123460, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'APPROVED', '11-SEP-2015', 123457, 1.22);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'DENIED', '09-NOV-2013', 123457, 1.10);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50005, 304, 'PENDING', NULL, 123457, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 306, 'APPROVED', '22-JAN-2012', 123458, 0.96); 

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 307, 'PENDING', NULL, 123458, NULL);  
