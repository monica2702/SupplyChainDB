...
SELECT 
    CUSTOMER_ID, CUSTOMER_NAME,NVL(COUNT(*),0), 
...
SELECT A.PART_APPR_ID AS APPROVAL_ID, A.PART_ID AS PART_ID, A.SUPP_ID, A.APP_STATUS AS STATUS,A.SUBMIT_DATE, A.APP_DATE AS STATUS_DATE, A.APP_COST AS COST,
...
SELECT APP_EMP_ID, EMP_NAME, ROUND(SUM(MONTHS_BETWEEN(STATUS_DATE,SUBMIT_DATE))) AS EVALUATION_DURATION FROM APPROVAL_WITH_EMPLOYEE 
WHERE STATUS != 'PENDING'
GROUP BY APP_EMP_ID, EMP_NAME
ORDER BY EVALUATION_DURATION;
