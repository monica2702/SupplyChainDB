...
INSERT INTO APPROVAL_DETAILS
    ...
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50000, 303, 'APPROVED','28-NOV-2017', '13-JAN-2018', 123460, 1.6, 500, 750);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50001, 305, 'APPROVED','02-NOV-2014', '20-JUL-2015', 123459, 0.43, 1000, 1200);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50002, 302, 'APPROVED','13-JAN-2012', '24-AUG-2013', 123458, 2.16, 250, 350);
    
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50004, 302, 'APPROVED','04-NOV-2013', '19-JAN-2014', 123460, 1.64, 220, 300);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50004, 302, 'PENDING','13-DEC-2018', NULL, 123460, NULL, 250, 350);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'APPROVED','10-AUG-2015', '11-SEP-2015', 123457, 1.22, 1000, 1200);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50003, 301, 'DENIED','07-OCT-2012', '09-NOV-2013', 123457, 1.10, 1000, 1200);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50005, 304, 'PENDING','05-FEB-2019', NULL, 123457, NULL, 100, 150);

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 306, 'APPROVED','09-MAY-2011', '22-JAN-2012', 123458, 0.96, 100, 200); 

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50007, 307, 'PENDING','03-MAR-2019', NULL, 123458, NULL, 150, 200); 
    
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50001, 308, 'APPROVED','12-SEP-2017', '01-DEC-2017', 123464, 0.69, 1100, 1350);  

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50004, 309, 'APPROVED','10-FEB-2014', '22-DEC-2014', 123465, 1.23, 450, 500);  

INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST, AVG_PROD_WEEKLY, MAX_PROD_WEEKLY)
    VALUES
    (PART_APP_ID_SEQ.NEXTVAL, 50005, 310, 'APPROVED','31-AUG-2017', '21-DEC-2017', 123457, NULL, 200, 350);
